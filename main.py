...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect = self.image.get_rect(midbottom = (200, 390))
        self.gravity = 0
...
programIcon = pygame.image.load('graphics/snail2.png')
...
back = pygame.image.load('graphics/01.gif').convert()
...
pl_rect = player_1.get_rect(midbottom = (80, 390))
pl_gravity = 0
...
game_name = TF.render('Helloooo', False, (111,196,169))
    ...
    for event in pygame.event.get():
        ...
        if Game_active:
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE and pl_rect.bottom >= 390:
                    pl_gravity = -20     
            
            
            if event.type == pygame.MOUSEBUTTONDOWN and pl_rect.bottom >= 390:      
                    pl_gravity = -20
        else:
